...
&ui_print_header("PostGIS Webmin Module<sup></sup> by <a href='https://www.acugis.com' target='blank'>Cited, Inc.</a> 2020 ", $text{'index_title'}, "", "intro", 1, 1, 0,
...
push(@links, "pg_reports.cgi");
push(@titles, 'Reports');
push(@icons, "images/table-reports.png");
